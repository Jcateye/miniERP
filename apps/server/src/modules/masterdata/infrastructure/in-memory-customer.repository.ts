...
export class InMemoryCustomerRepository implements CustomerRepository {
  private readonly store = new Map<string, Map<string, CustomerEntity>>();

  private getTenantStore(tenantId: string): Map<string, CustomerEntity> {
  ...
  async save(
    ...
    const tenantStore = this.getTenantStore(tenantId);
    const fullEntity: CustomerEntity = { ...entity, tenantId };
